...
import sys
import tempfile
from test_lifecycle_batch_process import provenance
from validate_lifecycle_batch_report import validate_unit_payload
...
def main():
    ...
    script=Path(__file__).resolve();test=script.parents[1]/'tests/test_n47g.cpp'
