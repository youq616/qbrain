...
import test_lifecycle_batch_process as suite
from validate_lifecycle_batch_report import validate_process, validate_unit, UNIT_SCENARIOS

class LifecycleBatchReportTests(unittest.TestCase):
    def fixture(self):
    ...
    def test_partial_unit_report_cannot_certify_atomic_rollback(self):
        r=self.unit()
        r['scenarios']=[s for s in r['scenarios'] if s['name']!='mid-archive SQL failure rolls back metadata and revisions']
