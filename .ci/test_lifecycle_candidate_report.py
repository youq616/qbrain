...
import test_lifecycle_candidate_process as suite
from validate_lifecycle_candidate_report import validate_process, validate_unit, UNIT_SCENARIOS

class LifecycleCandidateReportTests(unittest.TestCase):
    def fixture(self):
    ...
    def test_partial_unit_report_cannot_certify_continuation(self):
        r=self.unit()
        r['scenarios']=[s for s in r['scenarios'] if s['name']!='evidence work interruption resumes from the unfinished row']
