...
# N47G requires all 55 named groups; retain the historical validator default.
expected=verified_groups((root/'tests/test_main.cpp').read_text(encoding='utf-8'),read('regression.log'),expected_count=55)
